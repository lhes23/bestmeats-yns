					...
					<div className="mx-auto flex max-w-7xl items-center justify-between gap-x-4">
						<div className="flex items-center gap-x-4">
							<p className="text-center text-sm font-medium">
								🎉 San Diego’s Finest Wagyu Beef - Experience the finest marbled Wagyu, sourced for perfection
								and delivered fresh to your door.
							</p>
						</div>
					</div>
					<Link href={"/products"} className="bg-black rounded-full text-white px-4 py-1 text-sm">
						Shop Now
					</Link>
				</div>
			</div>
